<cfcomponent extends="admin.assets.cfcs.Component">
	...
	<cfset This.Columns = "SerialsShipmentsID,SHIUNIQ,LINENUM,ORDNUMBER,SerialNumber,Posted,PostedDate,ORDUNIQ,ORDLINENUM,INVUNIQ,INVLINENUM,AttachedToInvoice,BoxNumber">
