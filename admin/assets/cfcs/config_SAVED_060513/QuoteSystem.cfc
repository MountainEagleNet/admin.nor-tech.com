<cfcomponent extends="admin.assets.cfcs.Component">
	...
	<cfset This.Columns = "QuoteSystemID,CustomerID,SalesRepID,QuoteNumber,QuoteTitle,QuoteSubmitted,CustomerQuote,ConfigSystemID,SystemName,SystemAlias,SystemType,SystemPhoto,SystemConfigPhotoID,QuoteDate,ResellerPrice,Quantity,ResellerTotal,ResellerPONumber,ResellerComments,ShippingEstimate,ShippingCriteria,AdditionalWarrantyID,AdditionalWarrantyName,AdditionalWarrantyAmount,CustPrice,CustTotal,CustFirstName,CustLastName,CustTitle,CustCompany,CustAddress1,CustAddress2,CustCity,CustState,CustZip,CustIsPOBox,CustPhone,CustPhoneExtension,CustEmail,CustPONumber,CustComments,CustNoContact,SalesRepQuote,QuoteSent">
	...
	<cfargument name="OrderByList" type="string" required="Yes">
		...
		<cfif  SalesRepID IS NOT "">
            ...
            SELECT	tblQuoteSystem.QuoteSystemID, tblQuoteSystem.QuoteNumber, tblQuoteSystem.QuoteDate, tblQuoteSystem.SystemName, 
            		tblQuoteSystem.ResellerTotal, tblQuoteSystem.QuoteSent, tblQuoteSystem.Quantity, tblQuoteSystem.SalesRepQuote,
            		login.acctno AS CustomerNumber, login.company AS CustomerName
            FROM	tblQuoteSystem
