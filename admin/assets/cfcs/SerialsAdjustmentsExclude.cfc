<cfcomponent extends="admin.assets.cfcs.Component">
	...
	<cfset This.Columns = "SerialsAdjustmentsExcludeID,ADJENSEQ,RemoveComment">
	<cfset This.ViewColumns = This.Columns>
	
	<cfset This.TableName = "tblSerialsAdjustmentsExclude">
	<cfset This.ViewName = This.TableName>
	
	<cfset This.PrimaryKey = "SerialsAdjustmentsExcludeID">
	...
	<cfset This.SortColumn = "ADJENSEQ">
