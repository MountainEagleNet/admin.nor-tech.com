<!---
	...
	Task:			serials_counts_consec3_serials
--->
...
<cfset RemainingQuantity = stRecord.QUANTITY>
...
<cfset strScanner = objSerialsCounts.getScannerSettings("serials_counts_consec3_serials", stRecord.ITEMNO)>
...
<td valign="top" class="textmain">
	...
	<form action="index.cfm?task=serials_counts_consec3_serials_act&RequestTimeout=6000" method="Post" name="detailform">
