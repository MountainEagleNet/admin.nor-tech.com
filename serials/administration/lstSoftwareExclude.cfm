...
<!---
	...
	Function: 		This page displays a list of software excluded items
	Template:		lstSoftwareExclude.cfm
	Task:			serials_admin_SW_list
--->
	...
	<cfif isDefined("FORM.ITEMNO") AND isDefined("FORM.ITEMDESC")>
		...
		<cfset qrySoftwareExclude = objSoftwareExclude.searchRecords(SearchRecord, "query", Variables.OrderByList, 0)>
		<cfif qrySoftwareExclude.RecordCount EQ 0>
			<cfset Error = "No Match Found">
		</cfif>
	<cfelse>
		<cfset qrySoftwareExclude = objSoftwareExclude.listRecords("query", Variables.OrderByList)>
	</cfif>
...
<tr><!--- Page Title --->
	<td valign="top" class="subpagetitle" colspan="3">Software Excluded List</td>
</tr>

<tr><!--- Link back to "Add a New Item" --->
	<td valign="top" class="textmain" colspan="3" align="right">
		<a href="index.cfm?task=serials_admin_SW_new">
			Add a New Item
		</a>
	</td>
</tr>
...
<tr><!--- Display Message --->
	<td valign="top" class="textmain" colspan="3"><font color="FF0000">#objSoftwareExclude.getMessage()#</font></td>
</tr>
...
<form name="ItemNumberSearch" action="index.cfm?task=serials_admin_SW_list" method="post">
	<tr>
...
<td valign="top" class="textmain" colspan="3">
	...
	<tr>
		<td height="18" bgcolor="006633" width="40%">
			<a class="menuwh" href="index.cfm?task=serials_admin_SW_list&SortColumn=ITEMNO&SortOrder=#NewSortOrder#">
				Item Number
			</a>
		</td>
		<td height="18" bgcolor="006633" width="50%">
			<a class="menuwh" href="index.cfm?task=serials_admin_SW_list&SortColumn=ITEMDESC&SortOrder=#NewSortOrder#">
				Description
			</a>
		</td>
	...
	<cfif qrySoftwareExclude.RecordCount EQ 0>
		<tr>
			<td align="center" colspan="3" class="productTitle"><font color="FF0000">There are currently no Software Excluded Items on file.</font></td>
		</tr>
	</cfif>
	
	<cfloop query="qrySoftwareExclude">
		<tr<cfif qrySoftwareExclude.CurrentRow mod 2> style="background-color:##e5e5e6"</cfif>>
			<td class="textsmall" align="left">#qrySoftwareExclude.ITEMNO#</td>
			<td class="textsmall" align="left">#qrySoftwareExclude.ITEMDESC#</td>
			<td class="textsmall" align="center">
				<a href="index.cfm?task=serials_admin_SW_delete&SoftwareExcludeID=#urlEncodedFormat(qrySoftwareExclude.SoftwareExcludeID)#" onclick="return confirmDelete()">
					[delete]
				</a>
			</td>
		</tr>
