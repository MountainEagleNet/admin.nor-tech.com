...
<!---
	...
	Function: 		Close-Out Specials (Spiff) Report, criteria selection page
	Template:		frmSpiff.cfm
	Task:			serials_reports_frmSpiff
--->
	...
	<cfelse>
		...
		<cfset structInsert(stRecord, "SpiffPercentage", "", True)>
		<cfset structInsert(stRecord, "EmailAddress", "", True)>
...
<tr>
	<td class="textmain" style="font-size:16px; color:0033CC" height="18">
		<strong>Close-Out Specials (Spiff) Report</strong>
	<td>
</tr>

<tr><!--- Instructions --->
	<td valign="top" class="textmain">
		Enter selection criteria below.<br><br>
...
<td valign="top" class="textmain">
	...
	<form action="index.cfm?task=serials_reports_actSpiff&RequestTimeout=6000" method="Post" name="detailform">
	...
	<!--- SPIFF PERCENTAGE --->
	<cfif structKeyExists(stErrors, "SpiffPercentage")>
		<tr>
			<td>&nbsp;</td>
			<td valign="bottom" class="textmain" colspan="2"><font color="FF0000">&raquo; #stErrors.SpiffPercentage#</font></td>
		</tr>
	</cfif>
	<tr>
		<td class="textmain" align="left">
			<strong>Spiff Percentage:</strong>
		</td>
		<td class="textmain" align="left">
			<input name="SpiffPercentage" size="20" maxlength="50" value="#stRecord.SpiffPercentage#"> %
		</td>
	</tr>
	...
	<cfif structKeyExists(stErrors, "EmailAddress")>
		<tr>
			<td>&nbsp;</td>
			<td valign="bottom" class="textmain" colspan="2"><font color="FF0000">&raquo; #stErrors.EmailAddress#</font></td>
		</tr>
	</cfif>
	<tr>
		<td class="textmain" align="left">
		...
		<td class="textmain" align="left">
			<input name="EmailAddress" size="20" maxlength="50" value="#stRecord.EmailAddress#"> 
		</td>
	</tr>
...
<cfelseif structKeyExists(stErrors, "SpiffPercentage")>
	<script language="JavaScript" type="text/JavaScript">
	<!--
	document.detailform['SpiffPercentage'].focus(); document.detailform['SpiffPercentage'].select()
	-->
	</script>
<cfelseif structKeyExists(stErrors, "EmailAddress")>
	<script language="JavaScript" type="text/JavaScript">
	<!--
	document.detailform['EmailAddress'].focus(); document.detailform['EmailAddress'].select()
	-->
	</script>
<cfelse>
	<script language="JavaScript" type="text/JavaScript">
