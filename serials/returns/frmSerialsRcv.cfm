...
<!---
	...
	Function: 		This page displays a form for entering serial numbers for a chosen return item, Receiving phase
	Template:		frmSerialsRcv.cfm
	Task:			serials_returns_serialsrcv_edit
--->
	...
	<cfelse>
		...
		<cfif isDefined("URL.PrintBarCodeLabels") AND URL.PrintBarCodeLabels EQ 1> 
			<cfset ThePrintBarCodeBoxIsChecked = 1>
		<cfelse>
			<cfset BarSearchRecord = structNew()>
			<cfset structInsert(BarSearchRecord, "ITEMNO", qryDetail.ITEM, True)>
			<cfset qryPrintBarCodeItems = objPrintBarCodeItems.searchRecords(BarSearchRecord, "query")>
...
<cfset strScanner = objSerialsReturns.getScannerSettings("serials_returns_serialsrcv_edit", qryDetail.ITEM)>
...
<tr><!--- Page Title --->
	<td valign="top" class="subpagetitle">Receiving - Serial Number Entry</td>
</tr>
...
<td valign="top" class="textmain">
	...
	<tr>
		<td width="50%" valign="top">
			<!--- SERIAL NUMBERS ENTERED IN AUTHORIZATION PHASE --->
			<table cellpadding="2" cellspacing="0" width="100%" border="0">
			<tr>
				<td valign="top" class="textmain"><b>Serial Numbers - Authorized:</b></td>
			</tr>
			<cfif qrySerialsReturns.RecordCount EQ 0>
				<tr>
					<td valign="top" class="textmain"><font color="FF0000"><b>
						Warning: This RMA has no authorized serial numbers entered.
					</font></b></td>
				</tr>
			</cfif>
		...
		<td valign="top">
			<!--- SERIAL NUMBERS TO ENTER IN RECEIVING PHASE --->
			<table cellpadding="2" cellspacing="0" width="100%" border="0">
			
			<tr>
				<td valign="top" class="textmain"><b>Serial Numbers - Received:</b></td>
			</tr>
