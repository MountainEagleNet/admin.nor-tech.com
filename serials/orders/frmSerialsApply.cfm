...
<!---
	...
	Template:		frmSerialsApply.cfm
	Task:			serials_shipments_apply_edit
--->
...
<tr><!--- Instructions --->
	<td valign="top" class="textmain">
		Enter the Receipt Number that contains the serial numbers that you want to apply to this order.
	</td>
</tr>

<form name="ReceiptNumberSearch" action="index.cfm?task=serials_shipments_apply_act&RequestTimeout=6000" method="post">
