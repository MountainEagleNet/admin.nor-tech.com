...
<cfelse>
	...
	<cflocation url="index.cfm?task=serials_shipments_serials_edit&ORDUNIQ=#urlEncodedFormat(stRecord.ORDUNIQ)#&LINENUM=#urlEncodedFormat(stRecord.ORDLINENUM)#&StartBoxNumber=#StartBoxNumber#&LargeQuantity=1">
</cfif>