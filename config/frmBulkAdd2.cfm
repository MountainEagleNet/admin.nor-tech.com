<!---
	...
	Template:		frmBulkAdd2.cfm	
	Task:			config_setup_bulkadd_frm2
--->
...
<cfset Category = objComponentCategories.getCategory(strBulkComponent1.AddComponent)>
...
<tr>
	<td valign="top" class="textmain">
    	The component you chose to add, #strBulkComponent1.AddComponent#, is associated with the following categories.  Check the categories that you want to add this component to, then click "Add Component".<br />
        This function will add this component to all of the categories that you check below, to all of the configurations you selected on the previous page.<br />
    </td>
</tr>    
...
<td valign="top" class="textmain">
	...
	<form action="index.cfm?task=config_setup_bulkadd_act2&RequestTimeout=6000" method="Post" name="detailform">
	<cfset TabValue = 1>
	...
	<td valign="top" colspan="2" align="right">
		...
		<tr>
			<td align="center"><!--- "Add Component" BUTTON --->
				<input type="submit" name="ButtonClicked" value="Add Component" tabindex="#TabValue#" onclick="return disableButton()">
			</td>
		</tr>
		</table>
	</td>
