<!---
	...
	Template:		frmBulkReplace2.cfm	
	Task:			config_setup_bulkreplace_frm2
--->
...
<cfset Category = objComponentCategories.getCategory(strBulkComponent1.ReplaceComponent)>
...
<tr>
	<td valign="top" class="textmain">
    	You chose to replace component '#trim(strBulkComponent1.ReplaceComponent)#' with '#trim(strBulkComponent1.ReplaceComponentWith)#'.  These components are associated with the following categories.  Check the categories in which you want to replace this component, then click "Replace Component".<br />
        This function will replace this component in all of the categories that you check below, to all of the configurations you selected on the previous page.<br />
    </td>
</tr>    
...
<td valign="top" class="textmain">
	...
	<form action="index.cfm?task=config_setup_bulkreplace_act2&RequestTimeout=6000" method="Post" name="detailform">
	<cfset TabValue = 1>
	...
	<td valign="top" colspan="2" align="right">
		...
		<tr>
			<td align="center"><!--- "Add Component" BUTTON --->
				<input type="submit" name="ButtonClicked" value="Replace Component" tabindex="#TabValue#" onclick="return disableButton()">
			</td>
		</tr>
		</table>
	</td>
